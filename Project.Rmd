...
DF_CoalTS = na.approx(ts(DF_Coal$Value, start = c(1973, 1), end = c(2019, 10), frequency = 12))
DF_GasTS = na.approx(ts(DF_Gas$Value, start = c(1973, 1), end = c(2019, 10), frequency = 12))

x = cbind(DF_CoalTS, DF_GasTS)
plot.ts(x , main = "Coal and Natural Gas")
```
